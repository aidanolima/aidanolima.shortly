...
const translations = {
  en: {
    ...
    project_5_title: "Quinta do Monteiro Store",
    project_5_desc: "A complete e-commerce platform. It provides the best shopping experience for users and modern management tools to boost your sales.",
    project_6_title: "GestJus",
    project_6_desc: "Legal software focused on document and workflow automation. Ideal for law firms looking to increase productivity and reduce operational risks. It allows you to safely create, review, and store contracts.",
    project_7_title: "Park Portais do Roncador",
    project_7_desc: "In the mystical countryside where the savanna embraces ancient forests, this destination invites a deep immersion among secret trails and waterfalls echoing legends. Here, every step activates telluric energy and heals body and soul with natural elements and indigenous wisdom.",
  ...
  pt: {
    ...
    project_5_title: "Loja Quinta do Monteiro",
    project_5_desc: "Um e-commerce completo. Proporciona a melhor experiência de compra para o usuário e ferramentas modernas de gestão para impulsionar suas vendas.",
    project_6_title: "GestJus",
    project_6_desc: "Software jurídico com foco na automação de documentos e fluxos de trabalho. Ideal para escritórios que desejam aumentar a produtividade e reduzir riscos operacionais. Permite criar, revisar e armazenar contratos de forma segura.",
    project_7_title: "Park Portais do Roncador",
    project_7_desc: "No interior místico onde o cerrado abraça florestas ancestrais, o destino convida a uma imersão profunda entre trilhas secretas e cachoeiras que ecoam lendas. Aqui, cada passo ativa energia telúrica e cura o corpo e a alma com elementos naturais e saberes indígenas.",
  ...
  es: {
    ...
    about_description: "Profesional de TI con experiencia en grandes empresas y más de 22 años de experiencia en los sectores público y privado. Experiencia en Gestión de Proyectos de Desarrollo de Software, atendendo clientes en banca, telecomunicaciones y educación.",
    ...
    project_5_title: "Tienda Quinta do Monteiro",
    project_5_desc: "Un comercio electrónico completo. Proporciona la mejor experiencia de compra para el usuario y herramientas de gestión modernas para impulsar sus ventas.",
    project_6_title: "GestJus",
    project_6_desc: "Software jurídico centrado en la automatización de documentos y flujos de trabajo. Ideal para oficinas que desean aumentar la productividad y reducir los riesgos operativos. Permite crear, revisar y almacenar contratos de forma segura.",
    project_7_title: "Park Portais do Roncador",
    project_7_desc: "En el interior místico donde el cerrado abraza bosques ancestrales, el destino invita a una inmersión profunda entre senderos secretos y cascadas que resuenan leyendas. Aquí, cada paso activa la energía telúrica y sana el cuerpo y el alma con elementos naturales y sabiduría indígena.",
